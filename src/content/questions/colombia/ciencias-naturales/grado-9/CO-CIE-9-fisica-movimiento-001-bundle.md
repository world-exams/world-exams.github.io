---
id: "CO-CIE-9-fisica-movimiento-001"
country: "co"
grado: 9
...
# Pregunta Base: El Balón de Fútbol
...
**ID:** `CO-CIE-9-fisica-movimiento-001-v1`

### Enunciado
Según la **Primera Ley de Newton (Inercia)**, ¿por qué el balón estaba quieto antes de ser pateado?

### Opciones
- [x] A) Porque ninguna fuerza externa neta actuaba sobre él para cambiar su estado de reposo.
- [ ] B) Porque el balón no tiene masa.
...
**ID:** `CO-CIE-9-fisica-movimiento-001-v4`

### Enunciado
Cuando el balón golpea el poste y rebota, ¿qué ley de Newton explica el rebote?

### Opciones
- [x] A) Tercera Ley (Acción y Reacción).
- [ ] B) Segunda Ley (Fuerza = masa x aceleración).
...
### Enunciado
Si el mismo jugador patea un balón de plástico (menos masa) con la misma fuerza, ¿qué pasará con la aceleración en comparación con el balón de fútbol oficial?

### Opciones
- [x] A) La aceleración será mayor.
- [ ] B) La aceleración será menor.
