-- =============================================================================
-- MIGRATION: Business Model v2 - AI Credits & Adaptive Learning (FIXED)
-- Date: 2025-12-14
-- Description: Updates schema for weekly credit regeneration, user preferences,
--              and training sessions with generative content.
--              Includes DROP statements for conflicting tables.
-- =============================================================================

-- Drop conflicting tables if they exist (CASCADE to remove dependencies like party_usage_log)
DROP TABLE IF EXISTS public.party_usage_log CASCADE;
DROP TABLE IF EXISTS public.institutions CASCADE;
DROP TABLE IF EXISTS public.subscription_plans CASCADE;
DROP TABLE IF EXISTS public.profiles CASCADE; -- Just in case
...
-- Drop types if they exist to avoid conflicts
DROP TYPE IF EXISTS user_role CASCADE;
DROP TYPE IF EXISTS institution_plan CASCADE;
